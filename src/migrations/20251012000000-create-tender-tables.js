...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.addIndex('Tenders', ['published_date'], {
      name: 'tenders_published_date_idx',
      concurrently: false,
    });
    await queryInterface.addIndex('TenderApplications', ['tender_id'], {
      name: 'tender_applications_tender_id_idx',
      concurrently: false,
    });
    await queryInterface.addIndex('TenderApplications', ['applicant_id'], {
      name: 'tender_applications_applicant_id_idx',
      concurrently: false,
    });
    await queryInterface.addIndex('TenderApplications', ['status'], {
      name: 'tender_applications_status_idx',
      concurrently: false,
    });
    await queryInterface.addIndex('TenderApplications', ['tender_id', 'applicant_id'], {
      unique: true,
      name: 'tender_applications_tender_applicant_unique_idx',
      concurrently: false,
    });
  },
