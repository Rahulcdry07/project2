...
describe('Tender API Tests', () => {
  ...
  beforeEach(async function () {
    ...
    await ApplicationDocument.destroy({ where: {}, truncate: true, cascade: true, force: true });
    await TenderDocument.destroy({ where: {}, truncate: true, cascade: true, force: true });
    await TenderApplication.destroy({ where: {}, truncate: true, cascade: true, force: true });
    await Tender.destroy({ where: {}, truncate: true, cascade: true, force: true });
    ...
    testTender = await Tender.create({
      ...
      description:
        'This is a comprehensive test tender description with all necessary details for the construction project. It includes specifications and requirements.',
      ...
      currency: 'USD',
      submission_deadline: formatDate(30),
      published_date: formatDate(-1),
      status: 'Active',
  ...
  describe('GET /api/v1/tenders - List Tenders', () => {
    ...
    it('should filter tenders by category', async function () {
      ...
      await Tender.create({
        ...
        description:
          'This is a comprehensive IT services tender description for developing custom software solutions with detailed specifications.',
        ...
        currency: 'USD',
        submission_deadline: formatDate(45),
        published_date: formatDate(-1),
        status: 'Active',
      ...
      const res = await request(app).get('/api/v1/tenders?category=Construction');
    ...
    it('should filter tenders by location', async function () {
      ...
      const res = await request(app).get('/api/v1/tenders?location=New York');
    ...
    it('should filter tenders by status', async function () {
      ...
      const res = await request(app).get('/api/v1/tenders?status=Active');
    ...
    it('should search tenders by query string', async function () {
      ...
      const res = await request(app).get('/api/v1/tenders?q=Construction');
    ...
    it('should return empty array when no tenders match filters', async function () {
      ...
      const res = await request(app).get('/api/v1/tenders?category=NonExistent');
  ...
  describe('GET /api/v1/tenders/:id - Get Tender Details', () => {
    it('should return tender details by ID', async function () {
      ...
      const res = await request(app).get(`/api/v1/tenders/${testTender.id}`);
    ...
    it('should return 404 for non-existent tender', async function () {
      ...
      const res = await request(app).get('/api/v1/tenders/99999');
  ...
  describe('POST /api/v1/tenders - Create Tender', () => {
    it('should create a new tender with admin token', async function () {
      ...
      const newTender = {
        ...
        description:
          'This is a comprehensive healthcare project tender with detailed requirements and specifications for medical facility construction.',
        ...
        currency: 'USD',
        submission_deadline: formatDate(60),
        published_date: formatDate(-1),
        status: 'Active',
    ...
    it('should reject tender creation without authentication', async function () {
      ...
      const newTender = {
        ...
        description:
          'This is a comprehensive tender description with all necessary details and specifications for testing unauthorized access.',
      ...
      const res = await request(app).post('/api/v1/tenders').send(newTender);
    ...
    it('should reject tender creation with regular user token', async function () {
      ...
      const newTender = {
        ...
        description:
          'This is a comprehensive tender description testing whether regular users can create tenders without admin privileges.',
    ...
    it('should reject tender with duplicate reference number', async function () {
      ...
      const duplicateTender = {
        ...
        description:
          'This is a comprehensive tender description for testing duplicate reference number validation and error handling.',
    ...
    it('should reject tender with invalid category', async function () {
      ...
      const invalidTender = {
        ...
        description:
          'This is a comprehensive tender description for testing invalid category validation and proper error handling.',
    ...
    it('should reject tender with title too short', async function () {
      ...
      const shortTitleTender = {
        title: 'Short',
        description:
          'This is a comprehensive tender description with all necessary details and specifications for testing title validation.',
  ...
  describe('PUT /api/v1/tenders/:id - Update Tender', () => {
    ...
    it('should reject update without authentication', async function () {
      ...
      const res = await request(app).put(`/api/v1/tenders/${testTender.id}`).send(updates);
  ...
  describe('DELETE /api/v1/tenders/:id - Delete Tender', () => {
    it('should delete tender with admin token', async function () {
      ...
      const checkRes = await request(app).get(`/api/v1/tenders/${testTender.id}`);
    ...
    it('should reject delete without authentication', async function () {
      ...
      const res = await request(app).delete(`/api/v1/tenders/${testTender.id}`);
  ...
  describe('Tender Data Validation', () => {
    it('should accept all valid categories', async function () {
      ...
      for (let i = 0; i < categories.length; i++) {
        const tender = {
          ...
          description:
            'This is a comprehensive tender description with all necessary details and specifications for validation testing.',
    ...
    it('should preserve all tender fields on create', async function () {
      ...
      const completeTender = {
        ...
        description:
          'This is a comprehensive tender description with all necessary details, specifications, and requirements for testing.',
